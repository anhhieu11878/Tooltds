...
echo $do."[".$luc."🔰".$do."] ".$trang."=> ".$luc."Tool Được Khởi Động Vào Lúc: ".$tim.date("H:i:s")."\n";
echo $do."[".$luc."🔰".$do."] ".$trang."=> ".$luc."Tool By HIẾU\n";
echo $do."[".$luc."🔰".$do."] ".$trang."=> ".$luc."Chúc Bạn Ngày Mới Vui Vẽ\n";
echo $do."[".$luc."🔰".$do."] ".$trang."=> ".$luc."Ip Của Bạn Là: $ip\n";
echo $banner;
for ($makep=30;$makep > 0;$makep--){
echo $trang."=";
usleep(2500);
...
echo"\033[1;37m\033[1;41m \033[1;32m🌺\033[;33mHôm Nay Là Ngày $ngay Tháng $thang Năm $nam\033[1;32m🌺 \033[0m\n";
echo $do."[".$luc."🔰".$do."] ".$trang."=> ".$luc."Tool Được Khởi Động Vào Lúc: ".$tim.date("H:i:s")."\n";
echo $do."[".$luc."🔰".$do."] ".$trang."=> ".$luc."Tool By ANH HIẾU\n";
echo $do."[".$luc."🔰".$do."] ".$trang."=> ".$luc."Chúc Bạn Ngày Mới Vui Vẽ\n";
echo $do."[".$luc."🔰".$do."] ".$trang."=> ".$luc."Ip Của Bạn Là: $ip\n";
echo $banner;
for ($makep=30;$makep > 0;$makep--){
...
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Tool Auto TDS:$vang Đa Luồng\n";
...
if ($cauhinh["data"]["msg"] == "Cấu hình thành công!") {
	echo $thanhngang;
    echo $vang."[🔰ANHHIEU🔰]$luc - Đang Cấu Hình FB: ".$BYellow.$tenfb."".$res."\n";
    echo $thanhngang;
} 
$spam = 0;
while (true) {
...
if ( $stop == "n" ){
    ...
    echo $cuongdz.$luc."Cảm Ơn Bạn Đã Sử Dụng Tool Của HIẾU\n";
    exit;}
 else {
...
function hoanthanh($dem, $type, $id, $xujob, $xu) {
  ...
  echo "\r";
      echo "                                              \r";
    $a = "\033[1;33m[".$dem."\033[1;33m] \033[1;31m •\033[1;37m $t\033[1;31m •\033[1;3".$rd."m $type \033[1;31m•\033[1;30mĐã Ẩn Id\033[1;31m• \033[1;32m$xujob \033[1;31m• \033[1;93m".$xu."\n";
    $len = strlen($a);
    for ($x = 0; $x < $len; $x++) {
        echo $a[$x];
        usleep(1000);
...
function DELAY($amount)
{
  for($v=$amount;$v > 0;$v--)
  {
    print $vang."\r Nhiệm vụ chạy sau ".$do."$v".$vang." giây!!! \r";
    sleep(1);
}
}
